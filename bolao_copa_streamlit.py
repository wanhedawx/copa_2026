...
MATA_MATA = [{'id': 'M73',
 ...
 {'id': 'M88',
  ...
  'origem_visitante': {'tipo': 'grupo', 'grupo': 'G', 'pos': 2, 'label': '2º Grupo G', 'confirmado': 'Egito'}},
 {'id': 'M89',
  'fase': 'Oitavas',
  'data_hora': '2026-07-04 18:00',
  'estadio': 'Philadelphia Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M74', 'label': 'Vencedor M74'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M77', 'label': 'Vencedor M77'}},
 {'id': 'M90',
  'fase': 'Oitavas',
  'data_hora': '2026-07-04 14:00',
  'estadio': 'Houston Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M73', 'label': 'Vencedor M73'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M75', 'label': 'Vencedor M75'}},
 {'id': 'M91',
  'fase': 'Oitavas',
  'data_hora': '2026-07-05 17:00',
  'estadio': 'New York New Jersey Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M76', 'label': 'Vencedor M76'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M78', 'label': 'Vencedor M78'}},
 {'id': 'M92',
  'fase': 'Oitavas',
  'data_hora': '2026-07-05 21:00',
  'estadio': 'Mexico City Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M79', 'label': 'Vencedor M79'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M80', 'label': 'Vencedor M80'}},
 {'id': 'M93',
  'fase': 'Oitavas',
  'data_hora': '2026-07-06 16:00',
  'estadio': 'Dallas Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M83', 'label': 'Vencedor M83'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M84', 'label': 'Vencedor M84'}},
 {'id': 'M94',
  'fase': 'Oitavas',
  'data_hora': '2026-07-06 21:00',
  'estadio': 'Seattle Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M81', 'label': 'Vencedor M81'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M82', 'label': 'Vencedor M82'}},
 {'id': 'M95',
  'fase': 'Oitavas',
  'data_hora': '2026-07-07 13:00',
  'estadio': 'Atlanta Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M86', 'label': 'Vencedor M86'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M88', 'label': 'Vencedor M88'}},
 {'id': 'M96',
  'fase': 'Oitavas',
  'data_hora': '2026-07-07 17:00',
  'estadio': 'BC Place Vancouver',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M85', 'label': 'Vencedor M85'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M87', 'label': 'Vencedor M87'}},
 {'id': 'M97',
  'fase': 'Quartas',
  'data_hora': '2026-07-09 17:00',
  'estadio': 'Boston Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M89', 'label': 'Vencedor M89'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M90', 'label': 'Vencedor M90'}},
 {'id': 'M98',
  'fase': 'Quartas',
  'data_hora': '2026-07-10 16:00',
  'estadio': 'Los Angeles Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M93', 'label': 'Vencedor M93'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M94', 'label': 'Vencedor M94'}},
 {'id': 'M99',
  'fase': 'Quartas',
  'data_hora': '2026-07-11 18:00',
  'estadio': 'Miami Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M91', 'label': 'Vencedor M91'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M92', 'label': 'Vencedor M92'}},
 {'id': 'M100',
  'fase': 'Quartas',
  'data_hora': '2026-07-11 22:00',
  'estadio': 'Kansas City Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M95', 'label': 'Vencedor M95'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M96', 'label': 'Vencedor M96'}},
 {'id': 'M101',
  'fase': 'Semifinal',
  'data_hora': '2026-07-14 16:00',
  'estadio': 'Dallas Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M97', 'label': 'Vencedor M97'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M98', 'label': 'Vencedor M98'}},
 {'id': 'M102',
  'fase': 'Semifinal',
  'data_hora': '2026-07-15 16:00',
  'estadio': 'Atlanta Stadium',
  'origem_mandante': {'tipo': 'vencedor', 'jogo': 'M99', 'label': 'Vencedor M99'},
  'origem_visitante': {'tipo': 'vencedor', 'jogo': 'M100', 'label': 'Vencedor M100'}},
 {'id': 'M103',
  'fase': 'Terceiro lugar',
  'data_hora': '2026-07-18 18:00',
  'estadio': 'Miami Stadium',
  'origem_mandante': {'tipo': 'perdedor', 'jogo': 'M101', 'label': 'Perdedor M101'},
  'origem_visitante': {'tipo': 'perdedor', 'jogo': 'M102', 'label': 'Perdedor M102'}},
 {'id': 'M104',
  'fase': 'Final',
  'data_hora': '2026-07-19 16:00',
  'estadio': 'New York New Jersey Stadium',
...
def mesclar_resultados_oficiais(resultados_firebase):
    resultados = dict(RESULTADOS_OFICIAIS_ATUALIZADOS)

    if isinstance(resultados_firebase, dict):
        resultados.update(resultados_firebase)
...
def get_resultados():
    ...
    dados_firebase = doc.to_dict() or {}
    return mesclar_resultados_oficiais(dados_firebase)
...
def app():
    ...
    if menu == "Meus palpites":
        ...
        if is_admin:
            ...
            col_atualizar, col_limpar = st.columns(2)

            with col_atualizar:
                if st.button("⚡ Salvar resultados oficiais atualizados", use_container_width=True):
            ...
            with col_limpar:
                if st.button("🧹 Limpar resultados manuais do Firebase", use_container_width=True):
                    save_resultados({})
                    st.success("Resultados manuais limpos. Os resultados oficiais do código continuam aparecendo como base.")
                    st.rerun()
